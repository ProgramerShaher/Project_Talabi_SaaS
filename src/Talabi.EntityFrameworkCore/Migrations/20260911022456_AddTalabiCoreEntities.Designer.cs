...
namespace Talabi.Migrations
{
    ...
    [Migration("20260911022456_AddTalabiCoreEntities")]
    partial class AddTalabiCoreEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Talabi.Deliveries.DeliveryAssignment", b =>
                {
                    ...
                    b.Property<decimal?>("CourierEarning")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Talabi.Products.Inventory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppInventory", null, t =>
                        {
                            t.HasCheckConstraint("CK_Inventory_CurrentQuantity", "[CurrentQuantity] >= 0");
            ...
            modelBuilder.Entity("Talabi.Products.Inventory", b =>
                {
                    b.HasOne("Talabi.Products.Product", "Product")
                        .WithOne("Inventory")
                        .HasForeignKey("Talabi.Products.Inventory", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
