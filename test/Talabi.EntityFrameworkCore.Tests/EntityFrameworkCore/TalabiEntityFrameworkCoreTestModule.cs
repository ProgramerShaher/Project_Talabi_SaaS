...
[DependsOn(
    typeof(TalabiApplicationTestModule),
    typeof(TalabiEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class TalabiEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new TalabiDbContext(new DbContextOptionsBuilder<TalabiDbContext>().UseSqlite(_database.ConnectionString).Options));
